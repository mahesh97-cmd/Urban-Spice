...
const Footer = () => {
  return (<footer className="bg-[#111827]">
  <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="flex justify-center text-teal-600 sm:justify-start">
        <div className='logo  justify-center items-center relative '>
        {/* <img src={logo} alt="" className='rounded-full w-20'/> */}
        <h2 className='text-[#0F766E] '><span className=' font-bold text-4xl'>अ</span><span className='text-xl  font-semibold'>र्बन</span> <span className=' font-bold text-3xl'>S</span><span className='text-xl font-semibold'>pice</span></h2>
        <h3 className='text-[#0F766E] text-sm absolute left-6 '>भारत का स्वाद</h3>
      </div>
        </div>
