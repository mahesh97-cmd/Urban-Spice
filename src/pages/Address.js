  ...
  return (
    <div>
      <div className="xl:col-span-2 h-max rounded-md p-8 sticky top-0">
          <h2 className="text-2xl font-bold text-[#333]">Complete your Address</h2>
          <form className="mt-10">
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-6 max-sm:flex-col mt-10">
                ...
                <NavLink to="/payment" className="rounded-md px-6 py-3 w-full text-sm font-semibold bg-[#333] text-white hover:bg-[#222] flex justify-center items-center"><button type="button" className="">Complete Purchase</button></NavLink>
              </div>
            </div>
          </form>
        </div>
